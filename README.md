...
Search runs entirely in the browser using Fuse.js and a JSON index generated by Hugo. It is language-aware and works in subdirectory deployments by default.
